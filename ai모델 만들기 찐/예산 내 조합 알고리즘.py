...
# 가능한 모든 조합을 찾기
# valid_combinations = [list(range(min_price, user_budget + 1)) for min_price in min_prices.values() if min_price <= user_budget]
...
#     if total_price <= user_budget and total_price < min_total_price:
